...
export const subsidiaries: Subsidiary[] = [
  ...
  },
  {
    ...
    bgImage: bgImage,
    theme: "theme-tech",
    colorClass: "text-[#2A95BF]",
    gradientClass: "from-tech-primary to-tech-light",
