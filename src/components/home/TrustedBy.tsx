...
const logos: Logo[] = [
  {
    name: "Rakuten",
    svg: (
      <svg viewBox="0 0 100 30" className="h-7 w-auto" fill="currentColor">
  ...
  },
  {
    name: "NCR",
    svg: (
      <svg viewBox="0 0 80 30" className="h-7 w-auto" fill="currentColor">
  ...
  },
  {
    name: "monday.com",
    svg: (
      <svg viewBox="0 0 120 30" className="h-7 w-auto" fill="currentColor">
  ...
  },
  {
    name: "Disney",
    svg: (
      <svg viewBox="0 0 80 30" className="h-8 w-auto" fill="currentColor">
  ...
  },
  {
    name: "Stripe",
    svg: (
      <svg viewBox="0 0 70 30" className="h-7 w-auto" fill="currentColor">
  ...
  },
  {
    name: "Shopify",
    svg: (
      <svg viewBox="0 0 90 30" className="h-7 w-auto" fill="currentColor">
  ...
  },
  {
    name: "Slack",
    svg: (
      <svg viewBox="0 0 75 30" className="h-7 w-auto" fill="currentColor">
        ...
        <div className="flex-1 overflow-hidden">
          ...
          >
            {logos.map((logo) => (
              ...
              >
                <div
                  className="flex items-center justify-center px-4 py-3 rounded-xl transition-all duration-200 hover:bg-gray-50 cursor-pointer"
